...
이번 강의는 PyTorch 기초의 첫 번째 시간으로, Eager mode에 대해 다룹니다.
...
{`flowchart TD
    ...
    classDef xpu fill:#5b93ad,color:#fff,stroke:#48788e
    classDef external fill:none,stroke:#5b93ad,color:#5b93ad,stroke-dasharray: 6 4
`}
</Mermaid>
...
{`flowchart TD
  ...
  style hw fill:#6e8f72,stroke:#57735b,color:#fff
  style gen fill:#b3874f,stroke:#8f6b3c,color:#fff
`}
</Mermaid>
