...
{`flowchart TD
    ...
    classDef xpu fill:#2698ba,color:#fff,stroke:#1e7a95
    classDef external fill:none,stroke:#2698ba,color:#2698ba,stroke-dasharray: 6 4
`}
</Mermaid>
...
{`flowchart TD
  ...
  style hw fill:#8c6fc9,stroke:#7157a8,color:#fff
  style gen fill:#d0902f,stroke:#a87223,color:#fff
`}
</Mermaid>
