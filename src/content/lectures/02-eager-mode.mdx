...
{`flowchart TD
    ...
    classDef xpu fill:#29abe2,color:#fff,stroke:#1a8fc4
    classDef external fill:none,stroke:#29abe2,color:#29abe2,stroke-dasharray: 6 4
`}
</Mermaid>
...
{`flowchart TD
  ...
  torch --> torch_include["include/torch/csrc/\nautograd/generated"]
  torch --> torch_csrc["csrc/autograd/generated"]

  style hw fill:#3a7bd5,stroke:#2c5ea0,color:#fff
  style gen fill:#d97b1e,stroke:#a85d15,color:#fff
`}
</Mermaid>
