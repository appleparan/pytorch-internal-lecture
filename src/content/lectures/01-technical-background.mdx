...
현대 ML Framework에는 heterogeneous computing, distributed computing, compiler technology, numerical computing 분야에서 발전한 기술이 함께 사용됩니다.
...
ML Framework에 영향을 준 네 가지 기술 분야인 heterogeneous computing, supercomputing, ML compiler, numerical computing을 차례로 살펴봅니다.
...
슈퍼컴퓨팅은 대규모 계산을 처리하는 고성능 컴퓨팅 기술입니다. 전통적으로 물리학 시뮬레이션, 천문학, 기후 모델링, 항공우주 및 에너지 연구 등에 사용되었고, 현재는 대규모 머신러닝에도 사용됩니다.
