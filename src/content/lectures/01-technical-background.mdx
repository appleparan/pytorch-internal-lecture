...
- **Offline 참여자**: 강의 전 강의자료 보강, Q&A 대응
- **Online 참여자**: 강의 또는 강의자료에 대한 피드백/질문을 통해 강의자료 품질 향상에 기여

온라인 모임은 12월 4일부터 매주 수요일 저녁 7시에 진행되며, 휴일을 제외하고 총 12회 예정입니다. 강의자료는 GitHub과 Google Group을 통해 사전 배포됩니다. 간단한 질문은 슬라이드에 코멘트로, 복잡한 질문은 [GitHub repo](https://github.com/PyTorchKorea/pytorchcore-kr)에 issue로 남기면 됩니다.
...
- ML compiler — XLA, TensorRT, TVM 등
...
그리고 최종적으로 **Convergence on PyTorch** — 이 모든 기술이 PyTorch로 수렴하고 있는 흐름을 살펴봅니다.
